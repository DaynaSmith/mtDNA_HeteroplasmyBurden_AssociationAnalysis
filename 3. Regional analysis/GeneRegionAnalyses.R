...
# ═══════════════════════════════════════
# STEP 1: Annotate VCF with gene regions
# ═══════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════
# STEP 2: Calculate number of heteroplasmic variants in each gene region
# ═══════════════════════════════════════════════════════════════════════
...
# ════════════════════════════════════════════════════════════════════════════════════════
# STEP 3: Calculate difference in number of heteroplasmies per region between two groups
# ════════════════════════════════════════════════════════════════════════════════════════
...
# ═════════════════════════════════════════════════════════════════
# STEP 5: Run analysis for KhoeSan vs Non-KhoeSan African ancestry
# ═════════════════════════════════════════════════════════════════
...
regional_heteroplasmy <- calculate_regional_counts(
  vcf_file = "vcf_haplo_filtered.vcf.gz",
  metadata = metadata,
  vaf_type = "heteroplasmy"
)

# Test TB vs Control
tests_het <- test_regional_differences(
  regional_data = regional_heteroplasmy,
  group_var = "ancestry",
  group1_name = "KhoeSan African",
  group2_name = "Non-KhoeSan African"
)

print(tests_het)
write.csv(tests_het, "regional_heteroplasmy_tests.csv", row.names = FALSE)

# Plot
cohort1_het <- plot_regional_barplot(
  regional_data = regional_heteroplasmy,
  group_var = "ancestry",
  comparison_name = "KhoeSan versus non-KhoeSan African ancestry",
  test_results = tests_het
)
cohort1_het

ggsave("Heteroplasmy_regional_analysis.png", plot = cohort1_het, height = 8, width = 10, dpi = 300)
